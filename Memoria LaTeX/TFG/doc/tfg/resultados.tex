...
\begin{figure}[!h]
	\begin{center}
		\includegraphics[width=0.3\textwidth]{/capturas_app/login1.png}
...
\begin{figure}[!h]
	\begin{center}
		\includegraphics[width=0.3\textwidth]{/capturas_app/logintfno.png}
...
\begin{figure}[!h]
	...
	\begin{minipage}{.5\textwidth}
		\centering
		\includegraphics[width=0.6\textwidth]{/capturas_app/logincorreo.png}
...
Mediante estas opciones se facilita la tarea de gestión de los chats a los administradores de los mismos. Para eliminar un chat bastará con dejarlo pulsado en la lista de la actividad principal y se mostrará un cuadro de diálogo confirmando la eliminación (Figura \ref{fig:borrarchat}).
