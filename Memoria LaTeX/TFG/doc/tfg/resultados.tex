...
\begin{figure}[!h]
	\begin{center}
		\includegraphics[width=0.28\textwidth]{/capturas_app/inicioapp}
...
\begin{table}[!htbp]
	\centering
	{\small
		\input{tables/pondpesosemocion.tex}
	}
...
\begin{table}[!htbp]
	\centering
	{\small
		\input{tables/pondpesoslenguaje.tex}
	}
...
\begin{table}[!htbp]
	\centering
	{\small
		\input{tables/coloresmensaje.tex}
	}
