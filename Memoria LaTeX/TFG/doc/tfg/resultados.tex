...
\begin{figure}[!h]
	\begin{center}
		\includegraphics[width=0.8\textwidth]{/diagrama_flujo_watson}
...
\section{Sprint 4: Integración con Google Calendar y Funcionalidades Adicionales}
