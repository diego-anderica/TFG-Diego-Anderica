...
Este último Sprint se ha dedicado a la integración con Google Calendar, así como al desarrollo de funcionalidades adicionales a las ya existentes de cara a completar la aplicación final, puesto que la principal función de comunicación ya ha sido implementada en los Sprints anteriores.
