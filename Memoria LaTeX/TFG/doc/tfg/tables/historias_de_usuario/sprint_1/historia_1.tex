\resizebox{15cm}{!} {
	\begin{tabular}{|l|l|}
		...
		\hline
		\textbf{Prioridad:} Alta. & \textbf{Duración:} 50 horas.\\
		\hline
		\multicolumn{2}{|l|}{\textbf{Descripción:} Desarrollar una plataforma Web para facilitar la gestión de las familias.} \\
		\hline
		\multicolumn{2}{|l|}{\specialcell{\textbf{Casos de Uso:} Dar de Alta Nuevo Administrador, Dar de Baja Administrador,\\Dar de Alta Nuevo Docente, Dar de Baja Docente, Dar de Alta Nueva Familia,\\Dar de Baja Familia, Consultar Familias, Modificar Familias.}} \\
		\hline
